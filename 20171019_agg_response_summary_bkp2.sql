...
DROP TABLE IF EXISTS agg.respsumm_promo_nt_temp; --resp_ind_xref_ph
...
DROP TABLE IF EXISTS agg.respsumm_promo_p_temp; --resp_ph
...
DROP TABLE IF EXISTS agg.respsumm_olo_temp; --resp_mt_online_ord
...
DROP TABLE IF EXISTS agg.respsumm_oli_temp; --resp_mt_online_item
...
DROP TABLE IF EXISTS agg.respsumm_ofo_temp; --resp_mt_offline_ord
...
DROP TABLE IF EXISTS    agg.respsumm_emresp_temp; --resp_email_response
...
DROP TABLE IF EXISTS    agg.respsumm_olo_lj_oli_temp; --oi
CREATE TABLE            agg.respsumm_olo_lj_oli_temp
    ...
    AS
        SELECT
            ...
            , oli.canc_rsn_cd
            , oli.stat_cd
        FROM agg.respsumm_olo_temp olo
            LEFT JOIN agg.respsumm_oli_temp oli
                ON olo.ord_id = oli.ord_id;


DROP TABLE IF EXISTS    agg.respsumm_ph_ij_er_temp; --er
...
DROP TABLE IF EXISTS agg.respsumm_aggregation_done_temp; --mt_resp_summary_temp
...
DROP TABLE IF EXISTS    agg.agg_response_summary_acx_encode;
CREATE TABLE 			agg.agg_response_summary_acx_encode
(
...
/*DROP TABLE IF EXISTS    agg.agg_response_summary_acx;
CREATE TABLE            agg.agg_response_summary_acx
    DISTSTYLE KEY
    DISTKEY (individual_id)
    SORTKEY (individual_id)
    AS*/

truncate table agg.agg_response_summary_acx_encode;

INSERT INTO agg.agg_response_summary_acx_encode
SELECT
    individual_id
    , bus_unt
    , keycode
