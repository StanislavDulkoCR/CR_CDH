...
CREATE TABLE            cr_temp.indiv_ofo_xog_temp
    ...
    WHERE 1 = 1
          /*#TODO RM*/ AND xo.individual_id IN (1216297895, 1200000029, 1200000039, 1200000050, 1200000058, 1200000059, 1200000060, 1200000092, 1200000100, 1200000107, 1200000204, 1200000206, 1200000244, 1200000253, 1200000265, 1200000301, 1200000089, 1200000178, 1200000270, 1200000346, 1200000405, 1200000416, 1200000433, 1200000489, 1200000536, 1200000554, 1200000602, 1200000612, 1200000629, 1200000636, 1200000640, 1200000678, 1200000002,   1200068747, 1215843737 , 1214859928 , 1216798574,   1200068747, 1215843737 , 1214859928 , 1216798574)
    GROUP BY xo.individual_id;

analyse cr_temp.indiv_ofo_xog_temp;
...
analyse cr_temp.indiv_oli_xog_1_temp;
...
analyse cr_temp.indiv_oli_xog_2_temp;
...
analyse cr_temp.indiv_survey_resp_dt_temp;
/*------------------------------------UNTESTED------------------------------------*/
...
analyse cr_temp.indiv_webpage_temp;

DROP TABLE IF EXISTS    cr_temp.indiv_webpage_2_temp;
CREATE TABLE            cr_temp.indiv_webpage_2_temp
    DISTSTYLE KEY
    DISTKEY (individual_id)
    SORTKEY (individual_id)
    AS
        ...
        FROM cr_temp.indiv_webpage_temp page
        WHERE 1 = 1
              /*#TODO RM*/ AND page.individual_id IN (1216297895, 1200000029, 1200000039, 1200000050, 1200000058, 1200000059, 1200000060, 1200000092, 1200000100, 1200000107, 1200000204, 1200000206, 1200000244, 1200000253, 1200000265, 1200000301, 1200000089, 1200000178, 1200000270, 1200000346, 1200000405, 1200000416, 1200000433, 1200000489, 1200000536, 1200000554, 1200000602, 1200000612, 1200000629, 1200000636, 1200000640, 1200000678, 1200000002,   1200068747, 1215843737 , 1214859928 , 1216798574,   1200068747, 1215843737 , 1214859928 , 1216798574)
;

analyse cr_temp.indiv_webpage_2_temp;
...
analyse cr_temp.indiv_emailfavkey_temp;
...
analyse cr_temp.indiv_ibx_temp;

DROP TABLE IF EXISTS    cr_temp.indiv_email_fl_temp;--mt_ind_email_flag_temp
CREATE TABLE            cr_temp.indiv_email_fl_temp
    DISTSTYLE KEY
    DISTKEY (individual_id)
    SORTKEY (individual_id)
    ...
    WHERE 1 = 1 /*#TODO RM*/ AND a.individual_id IN (1216297895, 1200000029, 1200000039, 1200000050, 1200000058, 1200000059, 1200000060, 1200000092, 1200000100, 1200000107, 1200000204, 1200000206, 1200000244, 1200000253, 1200000265, 1200000301, 1200000089, 1200000178, 1200000270, 1200000346, 1200000405, 1200000416, 1200000433, 1200000489, 1200000536, 1200000554, 1200000602, 1200000612, 1200000629, 1200000636, 1200000640, 1200000678, 1200000002,   1200068747, 1215843737 , 1214859928 , 1216798574,   1200068747, 1215843737 , 1214859928 , 1216798574)
    GROUP BY a.individual_id;

analyse cr_temp.indiv_email_fl_temp;
...
analyse cr_temp.indiv_ind_xref_temp;
...
analyse cr_temp.indiv_ext_ref_dt_temp;
...
analyse cr_temp.indiv_cga_temp;
...
analyse cr_temp.indiv_preference_temp;
...
analyse cr_temp.indiv_off_canc_temp;
...
analyse cr_temp.indiv_oli_sku_temp;
...
CREATE TABLE cr_temp.indiv_onl_item_ord_temp
    ...
    WHERE 1 = 1
          /*#TODO RM*/ AND ot.individual_id IN (1216297895, 1200000029, 1200000039, 1200000050, 1200000058, 1200000059, 1200000060, 1200000092, 1200000100, 1200000107, 1200000204, 1200000206, 1200000244, 1200000253, 1200000265, 1200000301, 1200000089, 1200000178, 1200000270, 1200000346, 1200000405, 1200000416, 1200000433, 1200000489, 1200000536, 1200000554, 1200000602, 1200000612, 1200000629, 1200000636, 1200000640, 1200000678, 1200000002,   1200068747, 1215843737 , 1214859928 , 1216798574,   1200068747, 1215843737 , 1214859928 , 1216798574)
    GROUP BY ot.individual_id;

analyse cr_temp.indiv_onl_item_ord_temp;
...
analyse cr_temp.indiv_de_expires_temp;
...
analyse cr_temp.indiv_books_ord_temp;
...
WHERE 1 = 1
      /*#TODO RM*/ AND xr.individual_id IN (1216297895, 1200000029, 1200000039, 1200000050, 1200000058, 1200000059, 1200000060, 1200000092, 1200000100, 1200000107, 1200000204, 1200000206, 1200000244, 1200000253, 1200000265, 1200000301, 1200000089, 1200000178, 1200000270, 1200000346, 1200000405, 1200000416, 1200000433, 1200000489, 1200000536, 1200000554, 1200000602, 1200000612, 1200000629, 1200000636, 1200000640, 1200000678, 1200000002,   1200068747, 1215843737 , 1214859928 , 1216798574,   1200068747, 1215843737 , 1214859928 , 1216798574);

analyse cr_temp.indiv_misc_agg_temp;
...
analyse cr_temp.indiv_issue_lkp_acx_temp;
...
analyse cr_temp.indiv_print_lkp_temp;
...
CREATE TABLE            cr_temp.indiv_print_crdt_temp
    ...
    WHERE 1 = 1
          /*#TODO RM*/ AND er.individual_id IN (1216297895, 1200000029, 1200000039, 1200000050, 1200000058, 1200000059, 1200000060, 1200000092, 1200000100, 1200000107, 1200000204, 1200000206, 1200000244, 1200000253, 1200000265, 1200000301, 1200000089, 1200000178, 1200000270, 1200000346, 1200000405, 1200000416, 1200000433, 1200000489, 1200000536, 1200000554, 1200000602, 1200000612, 1200000629, 1200000636, 1200000640, 1200000678, 1200000002,   1200068747, 1215843737 , 1214859928 , 1216798574,   1200068747, 1215843737 , 1214859928 , 1216798574)
    GROUP BY er.individual_id;

analyse cr_temp.indiv_print_crdt_temp;
...
analyse cr_temp.indiv_bnb_temp;
...
analyse cr_temp.indiv_print_maglkp_temp;
...
analyse cr_temp.indiv_printsum_pref_temp;

DROP TABLE IF EXISTS    cr_temp.indiv_prospect_email_temp;
CREATE TABLE            cr_temp.indiv_prospect_email_temp
    DISTSTYLE KEY
    DISTKEY (individual_id)
    SORTKEY (individual_id)
    AS
...
analyse cr_temp.indiv_prospect_email_temp;
...
analyse cr_temp.indiv_misc_agg_2_temp;
...
analyse cr_temp.indiv_precalc_1_temp;
...
CREATE TABLE            cr_temp.indiv_precalc_2_temp
    ...
    FROM cr_temp.indiv_ind_xref_temp xr
        ...
        LEFT JOIN cr_temp.indiv_preference_temp a
            ON xr.individual_id = a.individual_id;

analyse cr_temp.indiv_precalc_2_temp;
...
CREATE TABLE            cr_temp.indiv_precalc_3_temp
    ...
    FROM cr_temp.indiv_ind_xref_temp xr
        ...
        LEFT JOIN cr_temp.indiv_bnb_temp bnb
            ON xr.individual_id = bnb.individual_id
;

analyse cr_temp.indiv_precalc_3_temp;

DROP TABLE IF EXISTS    cr_temp.indiv_precalc_4_temp;
CREATE TABLE            cr_temp.indiv_precalc_4_temp
    DISTSTYLE KEY
    DISTKEY (individual_id)
    SORTKEY (individual_id)
    AS
...
FROM cr_temp.indiv_ind_xref_temp xr
    ...
    LEFT JOIN cr_temp.indiv_print_maglkp_temp erm
        ON xr.individual_id = erm.individual_id
    LEFT JOIN cr_temp.indiv_printsum_pref_temp coop
        ON xr.individual_id = coop.individual_id
    LEFT JOIN cr_temp.indiv_survey_resp_dt_temp surv
        ON xr.individual_id = surv.individual_id
    LEFT JOIN cr_temp.indiv_webpage_temp page
        ON xr.individual_id = page.individual_id
    LEFT JOIN cr_temp.indiv_oli_xog_2_temp olixog2
        ON xr.individual_id = olixog2.individual_id
    LEFT JOIN cr_temp.indiv_oli_xog_1_temp olixog1
        ON xr.individual_id = olixog1.individual_id
    LEFT JOIN  cr_temp.indiv_ofo_xog_temp ofoxog
        ON xr.individual_id = ofoxog.individual_id
;


analyse cr_temp.indiv_precalc_4_temp;

DROP TABLE IF EXISTS    cr_temp.indiv_precalc_fin_temp;
CREATE TABLE            cr_temp.indiv_precalc_fin_temp
    DISTSTYLE KEY
    DISTKEY (individual_id)
    SORTKEY (individual_id)
    AS
        ...
        FROM cr_temp.indiv_ind_xref_temp xr
            LEFT JOIN cr_temp.indiv_precalc_1_temp precalc1
                ON xr.individual_id = precalc1.individual_id
            LEFT JOIN cr_temp.indiv_precalc_2_temp precalc2
                ON xr.individual_id = precalc2.individual_id
            LEFT JOIN cr_temp.indiv_precalc_3_temp precalc3
                ON xr.individual_id = precalc3.individual_id
            LEFT JOIN cr_temp.indiv_precalc_4_temp precalc4
                ON xr.individual_id = precalc4.individual_id
            --MISCELLANEOUS
            LEFT JOIN cr_temp.indiv_misc_agg_temp miscagg1
                ON xr.individual_id = miscagg1.individual_id
            LEFT JOIN cr_temp.indiv_misc_agg_2_temp miscagg2
                ON xr.individual_id = miscagg2.individual_id
            LEFT JOIN cr_temp.indiv_prospect_email_temp proem
                on xr.individual_id = proem.individual_id

            LEFT JOIN cr_temp.indiv_webpage_2_temp page2
                ON xr.individual_id = page2.individual_id
            LEFT JOIN cr_temp.indiv_email_fl_temp netflag
                ON xr.individual_id = netflag.individual_id
;

analyse cr_temp.indiv_precalc_fin_temp;
...
analyse cr_temp.indiv_aggregation_done_temp;
...
SELECT
    ...
    , ltd_don_cnt
    , non_prod_fst_dt
    , NVL(fst_non_prod_cd, 'NONE')             AS fst_non_prod_cd
    , non_prod_cnt
    , mrp_flg
    , fr_combined_flg
    , ind_combined_dt
    ...
    , ind_actv_cnt
    , ind_relship_cnt
    , NVL(fst_prod_cd, 'NONE')                 AS fst_prod_cd
...
FROM cr_temp.indiv_aggregation_done_temp
