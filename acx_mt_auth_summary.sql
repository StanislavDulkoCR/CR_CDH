...
* Module Name:   mt_auth_summary.sql
* Date:         3/29/2006
****************************************************************************/

--create table
CREATE TABLE mt_auth_summary
AS
SELECT
  ix.individual_id,
  ix.hh_id,
  ...
  max(CASE WHEN a.data_source IN ('DCK', 'KBL', 'LSR')
           ...
           ELSE null
      END) dcd_flg,
  substr(max(CASE WHEN ((a.data_source IN ('DCK', 'KBL', 'LSR') and a.auth_cd IN ('DNM', 'XXX') and a.auth_flg = 'Y')
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'ABQ')
                            ...
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_cd || a.scp_cd || a.auth_flg, 'EMAIL' || 'GLB' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'ABQ')
                                  OR (a.data_source in ('PWI','BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'ABQ')
                                  OR (a.data_source = 'CDS' and a.auth_cd = 'ABQEML')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND (a.auth_cd = 'ABQEML' or a.scp_cd != 'GLB')
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'ABQ')  -- same as above substr.  Note that oracle is smart enough to know it doesn't need to evaluate this substr twice
                                  OR (a.data_source in ('PWI','BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'ABQ')
                                  OR (a.data_source = 'CDS' and a.auth_cd = 'ABQEML')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND (a.auth_cd = 'ABQEML' or a.scp_cd != 'GLB')
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'Y', '1')
                       END), 9) = '1'
       THEN 'N'
       ELSE null
  END abq_non_prom_em_flg,
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'ADV')
                              ...
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.scp_cd || a.auth_flg, 'GLB' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'ADV')
                                  OR (a.data_source in ('PWI','BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'ADV')
                                  OR (a.data_source = 'CVO' and a.assoc_typ_cd = 'E' and a.auth_cd = 'EMAIL' and a.scp_cd = 'ADV')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'APS')
                              OR (a.data_source in ('PWI','BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'APS')
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.scp_cd || a.auth_flg, 'GLB' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'APS')
                                  OR (a.data_source in ('PWI','BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'APS')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'N', '1')
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CNS')
                       ...
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CNS')
                                  OR (a.data_source = 'PWI' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CNS')
                                  OR (a.data_source = 'CDS' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CNS')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'MGD')
                              OR (a.data_source in ('PWI', 'BMO', 'CU') and a.auth_cd = 'EMAIL' and a.scp_cd = 'MG')
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.scp_cd || a.auth_flg, 'GLB' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'MGD')
                                  OR (a.data_source in ('PWI', 'BMO', 'CU') and a.auth_cd = 'EMAIL' and a.scp_cd = 'MG')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'N', '1')
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CRE')
                       ...
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CRE')
                                  OR (a.data_source in ('PWI', 'BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'CRO')
                                  OR (a.data_source = 'CDS' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CRE')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('MKT', 'ABQ'))
                       ...
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('MKT', 'ABQ'))
                              OR (a.data_source in ('PWI', 'BMO') and a.auth_cd = 'EMAIL' and a.scp_cd in ('CRSCH', 'ABQ'))
                              OR (a.data_source = 'CDS' and a.auth_cd = 'ABQEML')
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                              AND (a.scp_cd != 'GLB' or a.auth_cd = 'ABQEML')
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.scp_cd || a.auth_flg, 'ABQ' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('MKT', 'ABQ'))
                              OR (a.data_source in ('PWI', 'BMO') and a.auth_cd = 'EMAIL' and a.scp_cd in ('CRSCH', 'ABQ'))
                              ...
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                              AND (a.scp_cd != 'GLB' or a.auth_cd = 'ABQEML')
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_cd || a.auth_flg, 'ABQEML' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('MKT', 'ABQ'))
                                  OR (a.data_source in ('PWI', 'BMO') and a.auth_cd = 'EMAIL' and a.scp_cd in ('CRSCH', 'ABQ'))
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'FUN')
                       ...
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'FUN')
                                  OR (a.data_source in ('PWI', 'BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'FR')
                                  OR (a.data_source IN ('DMP','CCC') and a.auth_cd = 'DNE' and a.scp_cd = 'FR')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
  ...
  END fr_non_prom_em_flg,
   CASE WHEN substr(max(CASE WHEN ( (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('ABQ',  'ADV', 'APS', 'CARP', 'CNS', 'CRE', 'CRH', 'CRM', 'FUN', 'MGD', 'MKT', 'NCB', 'UCB', 'SHM'))
        ...
        AND '1' || max(CASE WHEN ( (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('ABQ',  'ADV', 'APS', 'CARP', 'CNS', 'CRE', 'CRH', 'CRM', 'FUN', 'MGD', 'MKT', 'NCB', 'UCB', 'SHM'))
            ...
            <
            ----
            greatest(nvl(substr(max(CASE WHEN ( (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('ABQ',  'ADV', 'APS', 'CARP', 'CNS', 'CRE', 'CRH', 'CRM', 'FUN', 'MGD', 'MKT', 'NCB', 'UCB', 'SHM'))
                                           OR (a.data_source in ('PWI', 'BMO', 'CU') and a.auth_cd = 'EMAIL' and a.scp_cd in ('ABQ', 'ADV', 'APS', 'CARP', 'CNS', 'CRH', 'CRM', 'CRO', 'CRSCH', 'FR', 'MG', 'NCBK', 'UCBK', 'SHM'))
                                           OR (a.data_source = 'CDS' and a.auth_cd = 'ABQEML')
                                           OR (a.data_source = 'CDS' and a.auth_cd = 'EMAIL' and a.scp_cd in ('CNS', 'CRE', 'CRH', 'CRM', 'SHM'))
                                           OR (a.data_source IN ('DMP','CCC') and a.auth_cd = 'DNE' and a.scp_cd = 'FR')
                                     ...
                                     THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'N','1','0') || decode(a.auth_flg, 'N','0','1') || nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000')
                                END), 10), '0'),
                     nvl(substr(max(CASE WHEN ( (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('ABQ',  'ADV', 'APS', 'CARP', 'CNS', 'CRE', 'CRH', 'CRM', 'FUN', 'MGD', 'MKT', 'NCB', 'UCB', 'SHM'))
                                           OR (a.data_source in ('PWI', 'BMO', 'CU') and a.auth_cd = 'EMAIL' and a.scp_cd in ('ABQ', 'ADV', 'APS', 'CARP', 'CNS', 'CRH', 'CRM', 'CRO', 'CRSCH', 'FR', 'MG', 'NCBK', 'UCBK', 'SHM'))
                                           OR (a.data_source = 'CDS' and a.auth_cd = 'ABQEML')
                                           OR (a.data_source = 'CDS' and a.auth_cd = 'EMAIL' and a.scp_cd in ('CNS', 'CRE', 'CRH', 'CRM', 'SHM'))
                                           OR (a.data_source IN ('DMP','CCC') and a.auth_cd = 'DNE' and a.scp_cd = 'FR')
                     ...
                     nvl(substr(max(CASE WHEN ( (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('ABQ',  'ADV', 'APS', 'CARP', 'CNS', 'CRE', 'CRH', 'CRM', 'FUN', 'MGD', 'MKT', 'NCB', 'UCB', 'SHM'))
                                ...
                                END), 10), '0'))
       THEN 'N'
       WHEN substr(max(CASE WHEN ( (a.data_source in ('DGI', 'AMP') AND a.auth_cd = 'EMAIL' AND a.scp_cd in ('ABQ',  'ADV', 'APS', 'CARP', 'CNS', 'CRE', 'CRH', 'CRM', 'FUN', 'MGD', 'MKT', 'NCB', 'UCB', 'SHM'))
                                  OR (a.data_source in ('PWI', 'BMO', 'CU') and a.auth_cd = 'EMAIL' and a.scp_cd in ('ABQ', 'ADV', 'APS', 'CARP', 'CNS', 'CRH', 'CRM', 'CRO', 'CRSCH', 'FR', 'MG', 'NCBK', 'UCBK', 'SHM'))
                                  OR (a.data_source = 'CDS' and a.auth_cd = 'ABQEML')
                                  OR (a.data_source = 'CDS' and a.auth_cd = 'EMAIL' and a.scp_cd in ('CNS', 'CRE', 'CRH', 'CRM', 'SHM'))
                                  OR (a.data_source IN ('DMP','CCC') and a.auth_cd = 'DNE' and a.scp_cd = 'FR')
       ...
       ELSE null
  END non_prom_em_flg, 
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CRH')
                       ...
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CRH')
                                  OR (a.data_source = 'PWI' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CRH')
                                  OR (a.data_source = 'CDS' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CRH')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CRM')
                       ...
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CRM')
                                  OR (a.data_source = 'PWI' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CRM')
                                  OR (a.data_source = 'CDS' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CRM')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'NCB')
                              OR (a.data_source in ('PWI', 'BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'NCBK')
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.scp_cd || a.auth_flg, 'GLB' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'NCB')
                                  OR (a.data_source in ('PWI','BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'NCBK')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'N', '1')
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'UCB')
                              OR (a.data_source in ('PWI', 'BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'UCBK')
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.scp_cd || a.auth_flg, 'GLB' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'UCB')
                                  OR (a.data_source in ('PWI','BMO') and a.auth_cd = 'EMAIL' and a.scp_cd = 'UCBK')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'N', '1')
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'SHM')
                       ...
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'SHM')
                                  OR (a.data_source = 'PWI' and a.auth_cd = 'EMAIL' and a.scp_cd = 'SHM')
                                  OR (a.data_source = 'CDS' and a.auth_cd = 'EMAIL' and a.scp_cd = 'SHM')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
  ...
  CASE WHEN substr(max(CASE WHEN (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CARP')
                              OR (a.data_source = 'PWI' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CARP')
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.scp_cd || a.auth_flg, 'GLB' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'DGI' AND a.auth_cd = 'EMAIL' AND a.scp_cd = 'CARP')
                                  OR (a.data_source = 'PWI' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CARP')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'N', '1')
  ...
  ix.osl_hh_id,
    CASE WHEN substr(max(CASE WHEN (a.data_source = 'CVO' and a.assoc_typ_cd = 'E' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CVONEWS')
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.scp_cd || a.auth_flg, 'GLB' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'CVO' and a.assoc_typ_cd = 'E' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CVONEWS')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'N', '1')
                       END), 9) = '1'
  ...
  END adv_non_prom_news_em_flg,
      CASE WHEN substr(max(CASE WHEN (a.data_source = 'CVO' and a.assoc_typ_cd = 'E' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CVOAA')
                              OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM'))
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.scp_cd || a.auth_flg, 'GLB' || 'N', '1')
                       END), 9) = '1'
       THEN 'Y'
       WHEN substr(max(CASE WHEN ( (a.data_source = 'CVO' and a.assoc_typ_cd = 'E' and a.auth_cd = 'EMAIL' and a.scp_cd = 'CVOAA')
                                  OR (a.auth_cd = 'EMAIL' and a.scp_cd = 'GLB' and a.data_source not in ('AX', 'DM')) )
                             AND a.scp_cd != 'GLB'
                            THEN nvl(to_char(a.eff_dt,'YYYYMMDD'),'00000000') || decode(a.auth_flg, 'N', '1')
                       END), 9) = '1'
...
FROM middle_tier.ind_xref ix,
     middle_tier.mt_authorization a
WHERE ix.individual_id = a.individual_id
  AND ix.active_flag = 'A'
GROUP BY ix.individual_id, ix.hh_id, ix.ind_urn, ix.osl_hh_id
;
