...
from cr_temp.comp_diff_MT_FR_SUMMARY
 where 1=1 and ( 1=2
-- or fr_avg_don_amt_diff != ''
-- or fr_avg_gross_don_amt_diff != ''
-- or fr_lst_don_amt_diff != ''
-- or fr_ltd_don_amt_diff != ''
-- or fr_max_don_amt_diff != ''
-- or fr_prior_don_amt_diff != ''
...
---- or fr_coop_eligible_flg_diff != '' --joins to mt_individual
-- or (fr_lst_dm_don_amt_diff != ''  and fr_lst_dm_don_dt_diff != '')
