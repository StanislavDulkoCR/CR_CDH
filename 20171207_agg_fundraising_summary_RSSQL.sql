...
CREATE TABLE prod.agg_fundraising_summary
    ...
    AS
        SELECT
            ...
            /*, fr.ind_urn*/
            , fr.hh_id
            , cast(NVL(fr.fr_avg_don_amt, '0') AS DECIMAL(20, 2))         AS fr_avg_don_amt
            , cast(NVL(fr.fr_avg_gross_don_amt, '0') AS DECIMAL(20, 2))   AS fr_avg_gross_don_amt
            , cast(NVL(fr.fr_lst_don_amt, '0') AS DECIMAL(20, 2))         AS fr_lst_don_amt
            , cast(NVL(fr.fr_ltd_don_amt, '0') AS DECIMAL(20, 2))         AS fr_ltd_don_amt
            , cast(NVL(fr.fr_max_don_amt, '0') AS DECIMAL(20, 2))         AS fr_max_don_amt
            , cast(NVL(fr.fr_1_6_mth_don_amt, '0') AS DECIMAL(20, 2))     AS fr_1_6_mth_don_amt
            , cast(NVL(fr.fr_13_24_mth_don_amt, '0') AS DECIMAL(20, 2))   AS fr_13_24_mth_don_amt
            , cast(NVL(fr.fr_25_36_mth_don_amt, '0') AS DECIMAL(20, 2))   AS fr_25_36_mth_don_amt
            , cast(NVL(fr.fr_37_plus_mth_don_amt, '0') AS DECIMAL(20, 2)) AS fr_37_plus_mth_don_amt
            , cast(NVL(fr.fr_7_12_mth_don_amt, '0') AS DECIMAL(20, 2))    AS fr_7_12_mth_don_amt
            , cast(NVL(fr.fr_prior_don_amt, '0') AS DECIMAL(20, 2))       AS fr_prior_don_amt
            ...
            , cast(NVL(fr.fr_lst_rfl_don_amt, '0') AS DECIMAL(20, 2))     AS fr_lst_rfl_don_amt
            , cast(NVL(fr.fr_lst_non_rfl_don_amt, '0') AS DECIMAL(20, 2)) AS fr_lst_non_rfl_don_amt
            , cast(fr.fr_mbr_frst_strt_dt AS TIMESTAMP)                   AS fr_mbr_frst_strt_dt
            , fr.fr_mbr_lst_keycode
            , cast(NVL(fr.fr_mbr_lst_ren_don_amt, '0') AS DECIMAL(20, 2)) AS fr_mbr_lst_ren_don_amt
            , fr.fr_tof_cd
            , fr.fr_lt_dnr_flg
            , cast(NVL(fr.fr_mbr_lst_add_don_amt, '0') AS DECIMAL(20, 2)) AS fr_mbr_lst_add_don_amt
            ...
            , cast(fr.fr_max_don_amt_12_mth AS DECIMAL(20, 2))
            , cast(fr.fr_max_don_amt_24_mth AS DECIMAL(20, 2))
            , cast(fr.fr_max_don_amt_36_mth AS DECIMAL(20, 2))
            /*, fr.FR_LST_GUARDIAN_DON_DT*/
            /*, fr.FR_BRIDGE_PROGRAM_FLG*/
            , fr.fr_track_number
            , fr.fr_conv_tag_rsp_flg
            , cast(fr.fr_fst_don_amt AS DECIMAL(20, 2))
            ...
            , cast(fr.fr_lst_eml_don_amt AS DECIMAL(20, 2))
            ...
            , cast(NVL(fr.fr_lst_dm_don_amt, '0') AS DECIMAL(20, 2))      AS fr_lst_dm_don_amt
            , fr.fr_lst_dm_don_dt
            , cast(NVL(fr.fr_lst_org_onl_don_amt, '0') AS DECIMAL(20, 2)) AS fr_lst_org_onl_don_amt
            , fr.fr_lst_org_onl_don_dt
            , cast(NVL(fr.fr_lst_ecomm_don_amt, '0') AS DECIMAL(20, 2))   AS fr_lst_ecomm_don_amt
            ...
            , cast(NVL(fr.fr_mbr_basic_fst_amt, '0') AS DECIMAL(20, 2))   AS fr_mbr_basic_fst_amt
            , fr.fr_mbr_basic_lst_dt
            , cast(NVL(fr.fr_mbr_basic_lst_amt, '0') AS DECIMAL(20, 2))   AS fr_mbr_basic_lst_amt
            , fr.fr_ch_status
            , cast(NVL(fr.fr_ch_curr_ttl_don_amt, '0') AS DECIMAL(20, 2)) AS fr_ch_curr_ttl_don_amt
            , fr.fr_ch_lst_don_dt
            , fr.fr_ch_curr_strt_dt
            , cast(NVL(fr.fr_ch_lst_don_amt, '0') AS DECIMAL(20, 2))      AS fr_ch_lst_don_amt
