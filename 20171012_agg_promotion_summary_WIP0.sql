...
DROP TABLE IF EXISTS    cr_temp.promsum_individual_temp;
CREATE TABLE            cr_temp.promsum_individual_temp
...
-- #TODO RMV and individual_id in (  1216297895 , 1200000029 , 1200000039 , 1200000050 , 1200000058 , 1200000059 , 1200000060 , 1200000092 , 1200000100 , 1200000107 , 1200000204 , 1200000206 , 1200000244 , 1200000253 , 1200000265 , 1200000301 , 1200000089 , 1200000178 , 1200000270 , 1200000346 , 1200000405 , 1200000416 , 1200000433 , 1200000489 , 1200000536 , 1200000554 , 1200000602 , 1200000612 , 1200000629 , 1200000636 , 1200000640 , 1200000678 , 1200000002)
GROUP BY individual_id;


DROP TABLE IF EXISTS    cr_temp.promsum_ofo_summary_temp;
CREATE TABLE            cr_temp.promsum_ofo_summary_temp
       DISTSTYLE KEY DISTKEY(individual_id)
       SORTKEY(individual_id)
as
SELECT individual_id
...
DROP TABLE IF EXISTS    cr_temp.promsum_de_summary_temp;      
CREATE TABLE            cr_temp.promsum_de_summary_temp
       DISTSTYLE KEY DISTKEY(individual_id)
       SORTKEY(individual_id)
as
SELECT individual_id
...
-- #TODO RMV where individual_id in (  1216297895 , 1200000029 , 1200000039 , 1200000050 , 1200000058 , 1200000059 , 1200000060 , 1200000092 , 1200000100 , 1200000107 , 1200000204 , 1200000206 , 1200000244 , 1200000253 , 1200000265 , 1200000301 , 1200000089 , 1200000178 , 1200000270 , 1200000346 , 1200000405 , 1200000416 , 1200000433 , 1200000489 , 1200000536 , 1200000554 , 1200000602 , 1200000612 , 1200000629 , 1200000636 , 1200000640 , 1200000678 , 1200000002)
GROUP BY individual_id;


DROP TABLE IF EXISTS    cr_temp.promsum_promoresp_temp;
CREATE TABLE            cr_temp.promsum_promoresp_temp
       DISTSTYLE KEY DISTKEY(individual_id)
       SORTKEY(individual_id)
as
select 
...
-- #TODO RMV and pro.individual_id in (  1216297895 , 1200000029 , 1200000039 , 1200000050 , 1200000058 , 1200000059 , 1200000060 , 1200000092 , 1200000100 , 1200000107 , 1200000204 , 1200000206 , 1200000244 , 1200000253 , 1200000265 , 1200000301 , 1200000089 , 1200000178 , 1200000270 , 1200000346 , 1200000405 , 1200000416 , 1200000433 , 1200000489 , 1200000536 , 1200000554 , 1200000602 , 1200000612 , 1200000629 , 1200000636 , 1200000640 , 1200000678 , 1200000002)
;


DROP TABLE IF EXISTS    cr_temp.promsum_maxdt_temp;
CREATE TABLE            cr_temp.promsum_maxdt_temp
       DISTSTYLE KEY DISTKEY(individual_id)
       SORTKEY(individual_id)
as
WITH cte_ar AS
...
from cr_temp.promsum_individual_temp                    ix
  ...
  -- #TODO RMV where ix.individual_id in (  1216297895 , 1200000029 , 1200000039 , 1200000050 , 1200000058 , 1200000059 , 1200000060 , 1200000092 , 1200000100 , 1200000107 , 1200000204 , 1200000206 , 1200000244 , 1200000253 , 1200000265 , 1200000301 , 1200000089 , 1200000178 , 1200000270 , 1200000346 , 1200000405 , 1200000416 , 1200000433 , 1200000489 , 1200000536 , 1200000554 , 1200000602 , 1200000612 , 1200000629 , 1200000636 , 1200000640 , 1200000678 , 1200000002)
;
...
from cr_temp.promsum_maxdt_temp                     ixm
    ...
    left join cr_temp.promsum_de_summary_temp       de          
  ...
  -- #TODO RMV where ixm.individual_id in (  1216297895 , 1200000029 , 1200000039 , 1200000050 , 1200000058 , 1200000059 , 1200000060 , 1200000092 , 1200000100 , 1200000107 , 1200000204 , 1200000206 , 1200000244 , 1200000253 , 1200000265 , 1200000301 , 1200000089 , 1200000178 , 1200000270 , 1200000346 , 1200000405 , 1200000416 , 1200000433 , 1200000489 , 1200000536 , 1200000554 , 1200000602 , 1200000612 , 1200000629 , 1200000636 , 1200000640 , 1200000678 , 1200000002)
;
