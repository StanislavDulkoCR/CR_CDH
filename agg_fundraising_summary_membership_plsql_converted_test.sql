-- drop table MT_FR_SUMMARY_SDTEST_noindex;
create table MT_FR_SUMMARY_SDTEST_noindex as ( select * from MT_FR_SUMMARY_TEMP);
...
DECLARE
    ...
    CURSOR c_fr_donation IS
        ...
        FROM MT_FR_SUMMARY_SDTEST_noindex fs, agg_fundraising_donation fd, fundraising_membership fm, fr_prescircle_exclude pce
...
--             /*#TODO RMV*/ and fs.INDIVIDUAL_ID < 1200932027
    ...
    --
    mbr_gvng_lvl_cd               MT_FR_SUMMARY_SDTEST_noindex.fr_mbr_gvng_lvl_cd%TYPE;
    mbr_exp_dt                    MT_FR_SUMMARY_SDTEST_noindex.fr_mbr_exp_dt%TYPE;
    mbr_frst_strt_dt              MT_FR_SUMMARY_SDTEST_noindex.fr_mbr_frst_strt_dt%TYPE;
    mbr_lst_keycode               MT_FR_SUMMARY_SDTEST_noindex.fr_mbr_lst_keycode%TYPE;
    mbr_lst_ren_don_amt           MT_FR_SUMMARY_SDTEST_noindex.fr_mbr_lst_ren_don_amt%TYPE;
    mbr_lst_add_don_amt           MT_FR_SUMMARY_SDTEST_noindex.fr_mbr_lst_add_don_amt%TYPE;
    mbr_lst_add_don_dt            MT_FR_SUMMARY_SDTEST_noindex.fr_mbr_lst_add_don_dt%TYPE;
    mbr_pres_cir_frst_strt_dt     MT_FR_SUMMARY_SDTEST_noindex.fr_mbr_pres_cir_frst_strt_dt%TYPE;
...
BEGIN
    ...
    WHILE NOT c_fr_donation%NOTFOUND LOOP
        ...
        THEN
            ...
            THEN
                UPDATE MT_FR_SUMMARY_SDTEST_noindex
            ...
            END IF;
            IF v_row.gvng_lvl_cd = 'C' AND v_row.don_dt <= v_row.pce_qualifying_date
            THEN
                ...
                first_rec := 0;
            ELSIF v_row.flg_c_exists = 1 AND v_row.pce_individual_id IS NULL
                THEN
        ...
        --
        --3a. Renewal
        IF v_row.pce_qualifying_date IS NULL OR v_row.don_dt > v_row.pce_qualifying_date
        THEN
            ...
            ELSIF v_row.don_dt <= mbr_exp_dt
                  AND ((mbr_gvng_lvl_cd = 'S' AND v_row.don_amt >= 250)
                       ...
                       OR (mbr_gvng_lvl_cd = 'P' AND v_row.don_amt >= 1000))
                THEN
            ...
            ELSIF v_row.don_dt > mbr_exp_dt
                ...
                THEN
                    ...
                    mbr_lst_keycode := v_row.keycode;
            ELSIF v_row.don_amt > 0 AND nvl(substr(v_row.keycode, 2, 1), 'X') NOT IN ('2', '3')
                THEN
