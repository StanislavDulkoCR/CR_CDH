DROP TABLE IF EXISTS cr_temp.mt_ofl_brks_temp;
CREATE TABLE cr_temp.mt_ofl_brks_temp
...
DROP TABLE IF EXISTS cr_temp.mt_ofl_combine_temp_temp;
CREATE TABLE cr_temp.mt_ofl_combine_temp_temp
AS
...
DROP TABLE IF EXISTS cr_temp.mt_ofl_combine_temp;
CREATE TABLE cr_temp.mt_ofl_combine_temp
	DISTSTYLE KEY DISTKEY(individual_id) 
	INTERLEAVED SORTKEY(individual_id) 
AS
SELECT individual_id,
...
FROM cr_temp.mt_ofl_combine_temp_temp ct
GROUP BY individual_id;
        
DROP TABLE IF EXISTS cr_temp.mt_ofl_de_temp;
CREATE TABLE cr_temp.mt_ofl_de_temp
	DISTSTYLE KEY DISTKEY(individual_id) 
	INTERLEAVED SORTKEY(individual_id) 
AS
SELECT 
...
DROP TABLE IF EXISTS cr_temp.mt_ofl_sum_tmp1;
CREATE TABLE cr_temp.mt_ofl_sum_tmp1
	DISTSTYLE KEY DISTKEY(individual_id) 
	INTERLEAVED SORTKEY(individual_id) 
AS
...
DROP TABLE IF EXISTS cr_temp.mt_ofl_sum_tmp2;
CREATE TABLE cr_temp.mt_ofl_sum_tmp2
	DISTSTYLE KEY DISTKEY(individual_id) 
	INTERLEAVED SORTKEY(individual_id) 
AS
SELECT
...
DROP TABLE IF EXISTS cr_temp.agg_print_order_tmp3;
CREATE TABLE cr_temp.agg_print_order_tmp3
...
DROP TABLE IF EXISTS cr_temp.offline_account_tmp4;
CREATE TABLE cr_temp.offline_account_tmp4
	DISTSTYLE KEY DISTKEY(hash_account_id) 
	INTERLEAVED SORTKEY(hash_account_id) 
AS
select  
...
;
DROP TABLE IF EXISTS cr_temp.print_external_ref_temp;
CREATE TABLE cr_temp.print_external_ref_temp
	DISTSTYLE KEY DISTKEY(HASH_ACCOUNT_ID) 
	INTERLEAVED SORTKEY(HASH_ACCOUNT_ID) 
as 
...
;
DROP TABLE IF EXISTS cr_temp.print_cancel_act;
CREATE TABLE cr_temp.print_cancel_act
...
WHERE 
    ...
    -- (oa.hash_account_id IS NOT NULL OR oa.source_account_id IS NOT NULL OR de.individual_id IS NOT NULL)
...
FROM prod.individual ix 
    inner join cr_temp.mt_ofl_sum_temp ost on ix.individual_id = ost.individual_id
;
