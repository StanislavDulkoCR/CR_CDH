...
DROP TABLE IF EXISTS    cr_temp.fundraising_conv_tag_hist_temp;
CREATE TABLE            cr_temp.fundraising_conv_tag_hist_temp
AS
...
, fctr as (select mfd.individual_id
     from cr_temp.fundraising_donation_raw_temp         mfd
         ...
         ,cr_temp.fundraising_conv_tag_hist_temp        fcth          
     where
       (
